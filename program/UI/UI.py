...
# class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.programNameLabel.setGeometry(QtCore.QRect(240, 20, 350, 111))
        ###############
        self.MainWindow = MainWindow #引数MainWindowをクラス変数としてセット
        ...
        self.functionGBox.setGeometry(QtCore.QRect(30, 160, 700, 271))
        ...
        background-color: rgb(166, 166, 166);border-style: none;padding-top: 0px;margin 0px;}")
        self.functionGBox.setAlignment(QtCore.Qt.AlignCenter)
        self.functionGBox.setObjectName("functionGBox")

        ##########functionGBox_Label
        self.functionGBox_nameLabel = QtWidgets.QLabel(self.functionGBox)
        self.functionGBox_nameLabel.setGeometry(QtCore.QRect(300,10, 120, 40))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.functionGBox_nameLabel.setFont(font)
        self.functionGBox_nameLabel.setStyleSheet("background-color: rgb(166, 166, 166);")

        ##########healthyModeBtn
        self.healthyModeBtn = QtWidgets.QRadioButton(self.functionGBox)
        # self.healthyModeBtn.setGeometry(QtCore.QRect(22, 65, 180, 21))
        self.healthyModeBtn.setGeometry(QtCore.QRect(250, 75, 180, 21))
        ...
        self.mannerModeBtn.setGeometry(QtCore.QRect(250, 125, 180, 21))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
    ...
    def UI(self, MainWindow):
        ...
        self.functionGBox.setTitle(_translate("MainWindow", ""))
        self.functionGBox_nameLabel.setText(_translate("MainWindow", "function"))
